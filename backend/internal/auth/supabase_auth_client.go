...
func (c *SupabaseAuthClient) doRequest(ctx context.Context, method, path string, body interface{}) ([]byte, int, error) {
...
func (c *SupabaseAuthClient) doAdminRequest(ctx context.Context, method, path string, body interface{}, serviceRoleKey string) ([]byte, int, error) {
	var reqBody io.Reader
	if body != nil {
		b, err := json.Marshal(body)
		if err != nil {
...
func (c *SupabaseAuthClient) AdminCreateUser(ctx context.Context, serviceRoleKey string, email, password string, emailConfirm bool, metadata map[string]interface{}) (*AuthUser, error) {
	...
	data, status, err := c.doAdminRequest(ctx, http.MethodPost, "/admin/users", body, serviceRoleKey)
	if err != nil {
		return nil, err
	}
...
func (c *SupabaseAuthClient) AdminDeleteUser(ctx context.Context, serviceRoleKey, userID string) error {
	_, status, err := c.doAdminRequest(ctx, http.MethodDelete, "/admin/users/"+userID, nil, serviceRoleKey)
	if err != nil {
		return err
	}
