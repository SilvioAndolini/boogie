  ...
  const handlePay = async () => {
    ...
    try {
      const res = await fetch('/api/payments/card/create', {
        ...
        body: JSON.stringify({ monto, propiedadId, fechaEntrada, fechaSalida, cantidadHuespedes }),
      })
        ...
        <div className="relative p-5">
          <div className="mb-4 flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-[#9E9892]">Via MoonPay · Visa, Mastercard, Amex</p>
            </div>
          </div>
          ...
          <p className="mt-3 text-center text-[10px] text-[#9E9892]">
            MoonPay procesa tu tarjeta y envia USDT directamente. La reserva se confirma automaticamente.
          </p>
        </div>
      </div>
    )
    ...
    <div className="relative overflow-hidden rounded-2xl border border-[#E8E4DF] bg-gradient-to-br from-white to-[#F8F6F3]">
      ...
      <div className="relative p-5">
        <div className="mb-4 flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-sm font-bold text-[#1A1A1A]">Pago con Tarjeta</h3>
            <p className="text-[10px] text-[#9E9892]">Visa, Mastercard, Amex · via MoonPay</p>
          </div>
        </div>
        ...
        <div className="mb-4 rounded-xl bg-[#1B4332] p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <span className="rounded-lg bg-white/10 px-2 py-1 text-[10px] font-semibold text-white">USD → USDT</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-4 flex items-start gap-2 rounded-xl bg-[#F8F6F3] p-3">
          ...
          <div className="text-[10px] leading-relaxed text-[#6B6560]">
            <p className="font-semibold text-[#1A1A1A]">Como funciona</p>
            <p>MoonPay procesa tu tarjeta de forma segura, convierte el monto a USDT y lo envia al wallet del anfitrion. La reserva se confirma automaticamente.</p>
          </div>
        </div>
